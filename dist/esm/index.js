...
const EditableLabel = ({ text, onSave }) => {
    const [editing, setEditing] = reactExports.useState(false);
    const [value, setValue] = reactExports.useState(text);
    const handleEdit = () => {
        setEditing(true);
    };
    const handleSave = () => {
    ...
    if (editing) {
        return (React.createElement(Input, { value: value, onChange: handleChange, onBlur: handleSave, autoFocus: true }));
    }
    return (React.createElement(Box, { onClick: handleEdit },
